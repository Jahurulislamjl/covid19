        ...
        <nav class="sidebar-nav">
            ...
            <ul class="nav flex-column">
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav-menu-item" id="library-menu">
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <router-link to="/manage-exercise" class="nav-link">
                ...
                <li class="nav-item">
                    <a class="nav-link dropdown-toggle" id="patient-menu-dropdown">
                        <i class="nav-icon mdi mdi-circle-slice-3"></i>
                        Patients
                    </a>

                    <ul class="nav-menu-item" id="patient-menu">
                        <li class="nav-item">
                            <router-link to="/exercise" class="nav-link">
